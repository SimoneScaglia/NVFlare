...
def validate_global_models(data_path, models_path, iteration, num_clients, weights, results_dir, learning_rate=0):
    """
...
def main():
    ...
    base_path = os.path.join("/home/swarm-learning/repos/NVFlare/examples/advanced/swarm_slost/")
    
    # Test file path: {data_directory}/test.csv
    test_file_path = os.path.join(base_path, data_directory, "test.csv")
    ...
    if not os.path.exists(test_file_path):
        print(f"\nWarning: Test file not found at {test_file_path}")
        print("Creating directory structure and continuing...")
